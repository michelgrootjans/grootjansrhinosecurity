...
{
    public class GuestWithViewPermission : SecurityTest
    {
        ...
        public void ShouldExplainPermissions()
        {
            ...
            var message =
                "Permission (level 1) for operation '/Dossier/View' was granted to group 'guests' on 'everything' ('George W.' is a member of 'guests')\r\n";
